...
- First version: one issuer (xStocks), `exactIn` only, EOA wallets only (no EIP-1271), assets: USDG/USDC/USD₮0 ↔ AAPLx/NVDAx (sell direction added in v2; SPYx stays disabled for lack of a second source).
