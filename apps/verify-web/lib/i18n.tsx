...
const DICT = {
  ...
  nav_me: { en: "Local verification records", zh: "本机核验记录" },
  ...
  ag_mode_sim_opt: { en: "Simulation (no signature, no money)", zh: "模拟（不签名不花钱）" },
  ag_mode_live_opt: { en: "Live (sign an authorization next)", zh: "真实（之后签署授权）" },
