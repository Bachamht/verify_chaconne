...
const DICT = {
  ...
  nav_agent_tasks: { en: "My tasks", zh: "我的任务" },
  nav_agent_events: { en: "Event desk", zh: "事件台" },
  nav_agent_funds: { en: "Funds", zh: "我的资金" },
  ...
  ag_stop_note: { en: "Service-side stop only blocks new certificates. A certificate already pulled and not yet expired may still be executed. A hard stop is the on-chain revokeMandate confirmation (D-088).", zh: "服务侧停止只阻止后续签发；已取走且未过期的证书仍可能可执行。彻底停止以链上 revokeMandate 确认为准（D-088）。" },
